...
import { TransactionCardProps } from '../../components/TrasactionCard';
        ...
        <Container>

            {
                ...
                <>
                    ...
                    <HighlightCards >
                        <HighlightCard type="up" title="Entradas" amount={highlightData.entries.amount} lastTrasaction={highlightData.entries.lastTransaction} />
                        <HighlightCard type="down" title="Saídas" amount={highlightData.expensives.amount} lastTrasaction={highlightData.expensives.lastTransaction} />
                        <HighlightCard type="total" title="Total" amount={highlightData.total.amount} lastTrasaction={highlightData.total.lastTransaction} />
                    </HighlightCards>
